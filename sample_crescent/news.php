...
$stmt = $pdo->query("select * from news where posted <= CURDATE() order by posted desc limit ".NUM_NEWS);
        ...
        <div class="well well-lg">
          <div class="media">
            <a class="pull-left">
              ...
              <?php else: ?>
              <img class="media-object" src="images/press/press.png" height="64" width="64" alt="">
              <?php endif; ?>
            </a>
            <div class="media-body">
              <h4 class="media-heading"><?php echo h($item["title"]); ?>
                <small><?php $date = new DateTime($item["posted"]); ?>
                <?php echo $date->format("F j, Y"); ?></small>
              </h4>
